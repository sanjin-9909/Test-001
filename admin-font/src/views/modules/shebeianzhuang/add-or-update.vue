	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="运行状态" prop="yunxingzhuangtai" >
					<el-select :disabled="ro.yunxingzhuangtai" v-model="ruleForm.yunxingzhuangtai" placeholder="请选择运行状态"  filterable>
						<el-option
							v-for="(item,index) in yunxingzhuangtaiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="运行状态" prop="yunxingzhuangtai" >
					<el-input v-model="ruleForm.yunxingzhuangtai"
						placeholder="运行状态" readonly></el-input>
				</el-form-item>
				<el-form-item class="date" v-if="type!='info'" label="安装时间" prop="anzhuangshijian" >
					<el-date-picker
						...
						type="date"
						:readonly="ro.anzhuangshijian"
						placeholder="安装时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.anzhuangshijian" label="安装时间" prop="anzhuangshijian" >
					<el-input v-model="ruleForm.anzhuangshijian" placeholder="安装时间" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'" class="editorBox" label="安装详情" prop="anzhuangxiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.anzhuangxiangqing" 
					class="editor"
					myQuillEditor="anzhuangxiangqing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.anzhuangxiangqing" label="安装详情" prop="anzhuangxiangqing"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.anzhuangxiangqing"></span>
			</el-form-item>
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='yunxingzhuangtai'){
							this.ruleForm.yunxingzhuangtai = obj[o];
							this.ro.yunxingzhuangtai = true;
							continue;
						}
						...
						if(o=='anzhuangxiangqing'){
							this.ruleForm.anzhuangxiangqing = obj[o];
							this.ro.anzhuangxiangqing = true;
							continue;
						}
				...
				this.yunxingzhuangtaiOptions = "正常,异常,维修中".split(',')
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.anzhuangxiangqing = this.ruleForm.anzhuangxiangqing.replace(reg,'../../../springboot584f4022/upload');
					} else {
						this.$message.error(data.msg);
					}
				});

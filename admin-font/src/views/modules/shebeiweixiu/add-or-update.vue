...
<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-if="type!='info'" class="editorBox" label="维护记录" prop="weihujilu" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.weihujilu" label="维护记录" prop="weihujilu"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.weihujilu"></span>
			</el-form-item>
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.weihujilu = this.ruleForm.weihujilu.replace(reg,'../../../springboot584f4022/upload');
					} else {
						this.$message.error(data.msg);
					}
				});

		...
		<template v-if="showFlag ">
			...
			<div :style='{"width":"100%","padding":" 0px 15px 20px","boxShadow":"none","borderRadius":"24px","background":"#FFFFFF"}'>
				<el-table class="tables"
					...
					<el-table-column :resizable='true' :sortable='true' v-if="isAuth('tousujilu','审核')" prop="sfsh" label="回复">
						<template slot-scope="scope">
	...
	export default {
		...
		methods: {
			...
			shDialog(row){
				...
				if(row){
					this.shForm = {
						dapengmingcheng: row.dapengmingcheng,
						shebeimingcheng: row.shebeimingcheng,
						shebeileixing: row.shebeileixing,
						shebeitupian: row.shebeitupian,
						tousushijian: row.tousushijian,
						tousubeizhu: row.tousubeizhu,
						nonghuzhanghao: row.nonghuzhanghao,
						nonghuxingming: row.nonghuxingming,
						jishuyuanzhanghao: row.jishuyuanzhanghao,
						jishuyuanxingming: row.jishuyuanxingming,

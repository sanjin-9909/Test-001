	...
	<div class="main-content" :style='{"padding":"22px 28px"}'>
		...
		<template v-if="showFlag ">
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"30px","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative"}' v-if="!forumChild">
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","lineHeight":"40px","fontSize":"16px","fontWeight":"bold","height":"40px"}' class="item-label">帖子标题</label>
				...
				<el-row :style='{"padding":"30px","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative"}' v-if="forumChild">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 12px 0 10px","outline":"none","color":"#10C17C","borderRadius":"24px","background":"#DEF6ED","width":"auto","fontSize":"16px","minWidth":"160px","fontWeight":"bold","height":"41px"}' type="success" @click="search()">返回</el-button>
				</el-row>

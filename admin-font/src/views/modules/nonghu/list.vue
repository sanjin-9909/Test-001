...
<template>
	<div class="main-content" :style='{"padding":"22px 28px"}'>
			...
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"30px","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative"}' >
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","lineHeight":"40px","fontSize":"16px","fontWeight":"bold","height":"40px"}' class="item-label">农户账号</label>
				...
				<el-table class="tables"
					...
					<el-table-column :resizable='true' :sortable='true' prop="status" label="状态">
						<template slot-scope="scope">
							<el-switch
								...
								active-color="#10C17C"
								inactive-color="#ccc"
								@change="(e)=>nonghustatusChange(e,scope.row)">
							</el-switch>
						</template>
					</el-table-column>
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('nonghu','私聊')" type="success" @click="chatClick(scope.row)">
		...
		<template v-if="statType">
			<div class="statShow1">
				<div class="echarts1" v-if="isAuth('nonghu','农户活跃度')">
	...
	export default {
		...
		methods: {
			...
			chatClick(row) {
				...
				if(row.nonghuzhanghao){
					this.nowname = row.nonghuzhanghao
				}

	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.goumaijine" label="购买金额" prop="goumaijine" >
					<el-input v-model="ruleForm.goumaijine" placeholder="购买金额" readonly></el-input>
				</el-form-item>

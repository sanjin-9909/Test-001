...
<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-if="type!='info'" class="editorBox" label="擅长领域" prop="shanzhanglingyu" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.shanzhanglingyu" label="擅长领域" prop="shanzhanglingyu"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.shanzhanglingyu"></span>
			</el-form-item>
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shanzhanglingyu = this.ruleForm.shanzhanglingyu.replace(reg,'../../../springboot584f4022/upload');
					} else {
						this.$message.error(data.msg);
					}
				});

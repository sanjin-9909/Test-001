const base = {
	get() {
		return {
			url : "http://localhost:8080/springboot584f4022/",
			name: "springboot584f4022",
			// 退出到首页链接
			indexUrl: 'http://localhost:8080/springboot584f4022/front/dist/index.html'
		};
	},
	getProjectName(){
		return {
			projectName: "基于SpringBoot+Vue的果蔬大棚信息管理系统的设计与实现"
		} 
	},
	getUsersName(){
		return {

				...
				<el-table class="tables" :stripe='false'
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="table-btn5" type="success" @click.native="chapterClick(scope.row)" v-if="btnAuth('newstype','章节管理')">
	...
	export default {
		...
		methods: {
			...
			chapterClick (row){
				...
				this.$router.push({path: '/index/chapternewstype', query: params});
			},
		}
	}
</script>

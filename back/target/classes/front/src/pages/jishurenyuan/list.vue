		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<div class="list-btn-box">
					...
					<el-button class="list-add-btn" v-if="btnAuth('jishurenyuan','新增')" type="primary" @click="add('/index/jishurenyuanAdd')">
			...
			<div class="list">
				...
				<div class="list3 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box" >
						...
						<div class="item-info">
							<div>
								<div class="name">{{item.jishuyuanxingming}}</div>
								<div class="time_item">
							...
							<div class="desc ql-snow ql-editor" v-html="item.shanzhanglingyu"></div>
						</div>
					</div>
				</div>
			</div>
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`jishurenyuan/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/jishurenyuanDetail', query: params});
			},

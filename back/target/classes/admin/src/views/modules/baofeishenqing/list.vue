		...
		<template v-if="showFlag ">
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"30px","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative"}' >
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}' class="select" label="设备名称" prop="shebeimingcheng">
						...
						<el-select clearable v-model="searchForm.shebeimingcheng" placeholder="请选择设备名称" >
							<el-option v-for="(item,index) in shebeimingchengOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>

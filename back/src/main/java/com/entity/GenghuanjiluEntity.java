...
public class GenghuanjiluEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public GenghuanjiluEntity() {
		
	}
	
	public GenghuanjiluEntity(T t) {
		try {
	 ...
	 * 设置：更换备注
	 */
	public void setGenghuanbeizhu(String genghuanbeizhu) {
		this.genghuanbeizhu = genghuanbeizhu;
	}
	/**
	 * 获取：更换备注
	 */
	public String getGenghuanbeizhu() {
		return genghuanbeizhu;
	}
	/**
	 * 设置：农户账号
	 */

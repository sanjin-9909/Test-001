...
public class YujingxinxiModel  implements Serializable {
	...
	private String yujingxiangqing;
	...
	public void setYujingxiangqing(String yujingxiangqing) {
		this.yujingxiangqing = yujingxiangqing;
	}
	
	/**
	 * 获取：预警详情
	 */
	public String getYujingxiangqing() {
		return yujingxiangqing;
	}

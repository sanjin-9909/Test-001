...
public interface NonghuService extends IService<NonghuEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<NonghuEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<NonghuEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<NonghuEntity> wrapper);
